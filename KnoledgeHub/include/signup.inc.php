    ...
    if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
      ...
      exit();
        ...
        if($resultCheck > 0) {
          ...
          //     if($uid == $row['user_uid'] or $uid == $row['user_email']) {
          //       echo 'user id/email already exist';
          //       exit();
          //     }
          //     else {
                ...
                //Insert the user into the database
                  $sql = "INSERT INTO users (user_first,user_last,user_email,user_uid,user_uid,user_pwd,user_clg,user_IOF)
